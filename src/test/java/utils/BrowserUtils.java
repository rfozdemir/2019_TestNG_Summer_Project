...
public class BrowserUtils {
    ...
    public static void wait(int seconds) {
        try {
            ...
            e.printStackTrace();  //helps the programmer where the actual result occured
                                 //this method prints same message of e object also will show the line where exception is thrown
        }                        // this is very useful in diagnosing exception
    }
